    ...
    <DashboardLayout>
      ...
      <div className="responsive-grid-2">
        <div>
          {/* Profile */}
          <div style={card}>
            <h3 style={{ margin: "0 0 16px", fontSize: "16px", fontWeight: "600", color: text }}>👤 Profile</h3>
            <div style={{ display: "flex", alignItems: "center", gap: "14px", marginBottom: "20px" }}>
              ...
              <div>
                <p style={{ margin: "0 0 2px", fontSize: "16px", fontWeight: "600", color: text }}>{user?.firstName} {user?.lastName}</p>
                <p style={{ margin: 0, fontSize: "13px", color: muted }}>{user?.primaryEmailAddress?.emailAddress}</p>
              </div>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
              {[
                ...
                <div key={label}>
                  <p style={{ margin: "0 0 4px", fontSize: "12px", color: muted }}>{label}</p>
                  <p style={{ margin: 0, fontSize: "14px", color: text, fontWeight: "500" }}>{value}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Budget */}
          <div style={card}>
            <h3 style={{ margin: "0 0 16px", fontSize: "16px", fontWeight: "600", color: text }}>💰 Budget Settings</h3>
            <label style={{ fontSize: "13px", color: muted, display: "block", marginBottom: "8px" }}>Monthly Budget (₹)</label>
        ...
        <div>
          {/* Appearance */}
          <div style={card}>
            <h3 style={{ margin: "0 0 16px", fontSize: "16px", fontWeight: "600", color: text }}>🎨 Appearance</h3>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                <p style={{ margin: "0 0 2px", fontSize: "14px", fontWeight: "500", color: text }}>Dark Mode</p>
                <p style={{ margin: 0, fontSize: "13px", color: muted }}>Switch between light and dark theme</p>
              </div>
          ...
          {/* Notifications */}
          <div style={card}>
            <h3 style={{ margin: "0 0 16px", fontSize: "16px", fontWeight: "600", color: text }}>🔔 Notifications</h3>
            {[
              ...
              <div key={key} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 0", borderBottom: `1px solid ${dark ? "#2d2d44" : "#f3f4f6"}` }}>
                <div>
                  <p style={{ margin: "0 0 2px", fontSize: "14px", fontWeight: "500", color: text }}>{label}</p>
